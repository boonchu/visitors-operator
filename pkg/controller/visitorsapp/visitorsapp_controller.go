...
import (
	...
	operatorv1 "github.com/jdob/visitors-operator.git/pkg/apis/operator/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &operatorv1.VisitorsApp{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &operatorv1.VisitorsApp{},
	})
	if err != nil {
		return err
	}
